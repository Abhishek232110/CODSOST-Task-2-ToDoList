...
import InputTetx from "./inputText";
...
export default function TodoList() {
  ...
  return (
    <div className="md:flex justify-center w-full h-screen md:bg-transparent bg-zinc-300">
      <div className="bg-zinc-300 ms:w-1/2 w-full py-5">
        <div>
        ...
        <div className="flex flex-col w-full  pt-4">
          {array.map((task, index) => (
            <div key={index}>
              <div className=" flex justify-evenly py-2 space-x-1">
